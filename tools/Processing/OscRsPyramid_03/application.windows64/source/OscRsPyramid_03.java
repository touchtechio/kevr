...
public class OscRsPyramid_03 extends PApplet {
...
public void oscEvent(OscMessage msg) {
  ...
  if (msg.addrPattern().startsWith("/cursor")) {
    ...
    cursorX = (int) map (x, 0.7f, -0.7f, 0, width); 
    cursorY = (int) map (y, -0.5f, 0.5f, height/4, height*3/4);
    cursorZ = (int) map (z, 0.17f, 1.0f, 0, 400);
...
public class OPC implements Runnable
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "OscRsPyramid_03" };
    if (passedArgs != null) {
